                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                            ...
                                                            <p><span style="font-weight:bold;font-size:16px">Poruka od:</span> '.$sendername.'</p>
                                                            <p><span style="font-weight:bold;font-size:16px">Prezime:</span> '.$sendermessage.'</p>
                                                            <p><span style="font-weight:bold;font-size:16px">Email:</span> '.$emailaddress.'</p>
                                                            <p><span style="font-weight:bold;font-size:16px">Telefon:</span> '.$telephone.'</p>
                                                            </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="color:#b4b4b4;font-size:11px;padding-top:10px;line-height:15px;font-family:arial">
                                            <span> &copy; BOKEŠKI FORUM 2014 - '.$currYear.' - ALL RIGHTS RESERVED </span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
