<?php
	...
	------------------------------------------------------ */
	$receiver_email = "nvobokeskiforum@gmail.com";
	...
	----------------------------------------------------------------------------- */	
	$redirectForm = true;
	$redirectForm_url = "https://bokeskiforum.com/hvala-vam.html";
	
	/* Powered BY
	 * You will use both your website NAME and URL
	 * By default its powered by SMARTFORMS - https://tondotivat.me
	----------------------------------------------------------------------------- */
	$poweredby_name = "BOKEŠKI FORUM";
	$poweredby_url = "https://bokeskiforum.com/";	
